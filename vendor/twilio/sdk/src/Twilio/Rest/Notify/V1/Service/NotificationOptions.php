...
class CreateNotificationOptions extends Options {
    ...
    /**
     * The actions to display for the notification. For APNS, translates to the `aps.cuisine` value. For GCM, translates to the `data.twi_action` value. For SMS, this parameter is not supported and is omitted from deliveries to those channels.
     *
     * @param string $action The actions to display for the notification
     * @return $this Fluent Builder
     */
