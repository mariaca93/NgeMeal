...
abstract class TriggerOptions {
     ...
     * @param string $usageCuisine The usage cuisine of the UsageTriggers to read
     * @return ReadTriggerOptions Options builder
     */
    public static function read(string $recurring = Values::NONE, string $triggerBy = Values::NONE, string $usageCuisine = Values::NONE): ReadTriggerOptions {
        return new ReadTriggerOptions($recurring, $triggerBy, $usageCuisine);
    }
}
...
class ReadTriggerOptions extends Options {
     ...
     * @param string $usageCuisine The usage cuisine of the UsageTriggers to read
     */
    public function __construct(string $recurring = Values::NONE, string $triggerBy = Values::NONE, string $usageCuisine = Values::NONE) {
        $this->options['recurring'] = $recurring;
        $this->options['triggerBy'] = $triggerBy;
        $this->options['usageCuisine'] = $usageCuisine;
    }
    ...
    /**
     * The usage cuisine of the UsageTriggers to read. Must be a supported [usage cuisines](https://www.twilio.com/docs/usage/api/usage-record#usage-cuisines).
     *
     * @param string $usageCuisine The usage cuisine of the UsageTriggers to read
     * @return $this Fluent Builder
     */
    public function setUsageCuisine(string $usageCuisine): self {
        $this->options['usageCuisine'] = $usageCuisine;
        return $this;
    }
