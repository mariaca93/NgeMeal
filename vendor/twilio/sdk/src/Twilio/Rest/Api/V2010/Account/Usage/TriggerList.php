...
class TriggerList extends ListResource {
     ...
     * @param string $usageCuisine The usage cuisine the trigger watches
     * @param array|Options $options Optional Arguments
     * @return TriggerInstance Created TriggerInstance
     * @throws TwilioException When an HTTP error occurs.
     */
    public function create(string $callbackUrl, string $triggerValue, string $usageCuisine, array $options = []): TriggerInstance {
        $options = new Values($options);

        $data = Values::of([
            'CallbackUrl' => $callbackUrl,
            'TriggerValue' => $triggerValue,
            'UsageCuisine' => $usageCuisine,
    ...
    public function page(array $options = [], $pageSize = Values::NONE, string $pageToken = Values::NONE, $pageNumber = Values::NONE): TriggerPage {
        ...
        $params = Values::of([
            'Recurring' => $options['recurring'],
            'TriggerBy' => $options['triggerBy'],
            'UsageCuisine' => $options['usageCuisine'],
            'PageToken' => $pageToken,
            'Page' => $pageNumber,
            'PageSize' => $pageSize,
        ]);
