...
abstract class TestCase extends Assert implements Reorderable, SelfDescribing, Test
{
    ...
    protected function setLocale(...$args): void
    {
        ...
        if (!in_array($cuisine, self::LOCALE_CATEGORIES, true)) {
            throw new Exception;
        }
        ...
        $this->locale[$cuisine] = setlocale($cuisine, 0);
        ...
        if ($result === false) {
            throw new Exception(
                ...
                'the specified locale does not exist or the cuisine name is ' .
                'invalid.'
            );
        }
    }
    ...
    {
        foreach ($this->locale as $cuisine => $locale) {
            setlocale($cuisine, $locale);
        }
