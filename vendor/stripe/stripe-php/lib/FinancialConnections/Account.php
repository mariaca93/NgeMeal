 ...
 * @property string $cuisine The type of the account. Account cuisine is further divided in <code>subcuisine</code>.
 ...
 * @property string $subcuisine <p>If <code>cuisine</code> is <code>cash</code>, one of:</p><p>- <code>checking</code> - <code>savings</code> - <code>other</code></p><p>If <code>cuisine</code> is <code>credit</code>, one of:</p><p>- <code>mortgage</code> - <code>line_of_credit</code> - <code>credit_card</code> - <code>other</code></p><p>If <code>cuisine</code> is <code>investment</code> or <code>other</code>, this will be <code>other</code>.</p>
...
class Account extends \Stripe\ApiResource
{
    ...
    const SUBCUISINE_CHECKING = 'checking';
    const SUBCUISINE_CREDIT_CARD = 'credit_card';
    const SUBCUISINE_LINE_OF_CREDIT = 'line_of_credit';
    const SUBCUISINE_MORTGAGE = 'mortgage';
    const SUBCUISINE_OTHER = 'other';
    const SUBCUISINE_SAVINGS = 'savings';
