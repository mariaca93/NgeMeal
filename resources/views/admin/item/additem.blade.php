...
@section('styles')
    <link rel="stylesheet"
        href="{{ url('storage/app/public/admin-assets/assets/css/bootstrap/bootstrap-select.v1.14.0-beta2.min.css') }}">
@endsection
@section('content')
                            ...
                            <form method="post" action="{{ URL::to('admin/item/store') }}" name="about" id="about"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                                    ...
                                                    <select name="cuisine_id" class="form-select" id="cuisine_id"
                                                        ...
                                                        @foreach ($getcuisine as $cuisine)
                                                            <option value="{{ $cuisine->id }}"
                                                                ...
                                                                data-id="{{ $cuisine->id }}">{{ $cuisine->cuisine_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    @error('cuisine_id')
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="subcuisine_id"
                                                        class="col-form-label">{{ trans('labels.subcuisine') }}</label>
                                                    <select name="subcuisine_id" class="form-select" id="subcuisine_id">
                                                        <option value="" selected>{{ trans('labels.select') }}
                                                        </option>
                                                    </select>
                                                    @error('subcuisine_id')
                                ...
                                <div class="row panel-body dn @if ($errors->has('variation.*') || $errors->has('product_price.*') || old('has_variation') == 1) d-flex @endif"
                                    ...
                                    <div class="col-sm-1 d-flex align-items-end">
                                        <div class="form-group">
                                            <button class="btn btn-info" type="button" onclick="variation_fields('{{ trans('labels.variation') }}','{{ trans('labels.product_price') }}','{{ trans('labels.sale_price') }}');"> <i class="fa-sharp fa-solid fa-plus"></i> </button>
                                        </div>
                                    </div>
                                </div>
...
@endsection
@section('script')
    <script src="{{ url('storage/app/public/admin-assets/assets/js/bootstrap/bootstrap-select.v1.14.0-beta2.min.js') }}">
    </script>
