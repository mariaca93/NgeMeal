                                                    ...
                                                    <select name="cuisine_id" class="form-select" id="cuisine_id"
                                                        ...
                                                        @foreach ($getcuisine as $cuisine)
                                                            <option value="{{ $cuisine->id }}"
                                                                {{ $getitem->cuisine_id == $cuisine->id ? 'selected' : '' }}
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="subcuisine_id" class="form-select" id="subcuisine_id">
                                                        ...
                                                        @foreach ($getsubcuisine as $subcatdata)
                                                            <option value="{{ $subcatdata->id }}"
                                                                {{ $getitem->subcuisine_id == $subcatdata->id ? 'selected' : '' }}>
                                                                {{ $subcatdata->subcuisine_name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('subcuisine_id')
                                                        <span class="text-danger">{{ $message }}</span>
