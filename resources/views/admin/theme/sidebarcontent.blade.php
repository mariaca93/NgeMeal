...
<ul class="navbar-nav">
    ...
    <li class="nav-item mb-2 fs-7 {{ Auth::user()->type != 1 ? (in_array('7', $modules) == true ? '' : 'd-none') : '' }}" id="7">
        <a class="nav-link rounded d-flex {{ request()->is('admin/cuisine*') ? 'active' : '' }}" href="{{ URL::to('/admin/cuisine') }}" aria-expanded="false">
            <i class="fa-sharp fa-solid fa-list"></i><span class="nav-text ">{{ trans('labels.cuisines') }}</span>
        </a>
    </li>
    <li class="nav-item mb-2 fs-7 {{ Auth::user()->type != 1 ? (in_array('8', $modules) == true ? '' : 'd-none') : '' }}" id="8">
        <a class="nav-link rounded d-flex {{ request()->is('admin/sub-cuisine*') ? 'active' : '' }}" href="{{ URL::to('/admin/sub-cuisine') }}" aria-expanded="false">
            <i class="fa-solid fa-list-tree"></i><span class="nav-text ">{{ trans('labels.subcuisines') }}</span>
        </a>
    </li>
