<div class="row page-titles mx-0 mb-3">
    <div class="d-flex justify-content-between align-items-center">
        <ol class="breadcrumb mb-0">
            ...
            @endif
            @if (request()->is('admin/cuisine*'))
                <li class="breadcrumb-item"><a href="{{ URL::to('admin/cuisine') }}">{{ trans('labels.cuisines') }}</a></li>
            @endif
            @if (request()->is('admin/sub-cuisine*'))
                <li class="breadcrumb-item"><a href="{{ URL::to('admin/sub-cuisine') }}">{{ trans('labels.subcuisines') }}</a></li>
            @endif
        ...
        @endif
        @if (request()->is('admin/slider') || request()->is('admin/addons') || request()->is('admin/cuisine') || request()->is('admin/sub-cuisine') || request()->is('admin/promocode') || request()->is('admin/driver') || request()->is('admin/blogs') || request()->is('admin/our-team') || request()->is('admin/tutorial') || request()->is('admin/faq') || request()->is('admin/gallery') || request()->is('admin/roles') || request()->is('admin/employee') || request()->is('admin/item') || request()->is('admin/notification'))
