            ...
            <div class="col-lg-12">
                <div class="form-validation">
                    <form action="{{ URL::to('admin/settings/update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mt-3 mb-2">
                            <h5><i class="fa-solid fa-address-card"></i> Contact Settings</h5>
                        </div>
                    ...
                    @csrf
                        <div class="mt-3 mb-2">
                            <h5><i class="fa-regular fa-earth-americas"></i> Third Party Settings </h5>
                        </div>
                        <div class="card border-0">
                            <div class="card-body">
                                <div class="row">
                    ...
                    @csrf
                        <div class="mt-3 mb-2">
                            <h5><i class="fa-solid fa-share-nodes"></i> SEO Settings </h5>
                        </div>
                        <div class="card border-0">
                            <div class="card-body">
                                <div class="row">
                    ...
                    @csrf
                        <div class="mt-3 mb-2">
                            <h5><i class="fa-solid fa-briefcase"></i> Business Settings </h5>
                        </div>
                        <div class="card border-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for="">{{ trans('labels.currency') }}
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for="">{{ trans('labels.currency_position') }}
                                            </label>
                                            <div class="d-flex">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for="">{{ trans('labels.maintenance_mode') }}
                                            </label>
                                            <input id="maintenance_mode-switch" type="checkbox" class="checkbox-switch" name="maintenance_mode" value="1"
                    ...
                    @csrf
                        <div class="mt-3 mb-2">
                            <h5><i class="fa-solid fa-browser"></i> Website Settings </h5>
                        </div>
                        <div class="card border-0">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-form-label" for="">{{ trans('labels.footer_features') }} <span class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Ex. <i class='fa-solid fa-truck-fast'></i> Visit https://fontawesome.com/ for more info"> <i class="fa-solid fa-circle-info"></i> </span>  </label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 form-group">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            placeholder="{{ trans('labels.icon') }}" value="{{ $features->icon }}" required>
                                                    </div>
                                                    <div class="col-md-3 form-group">
                                                        <input type="text" class="form-control"
                                                            name="edi_feature_title[{{ $features->id }}]"
                                                            placeholder="{{ trans('labels.title') }}" value="{{ $features->title }}" required>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3 form-group">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control feature_required" onkeyup="show_feature_icon(this)"
                                                            name="feature_icon[]"
                    ...
                    @csrf
                        <div class="mt-3 mb-2">
                            <h5><i class="fa-solid fa-mobile-notch"></i> Mobile App Settings </h5>
                        </div>
                        <div class="card border-0">
                            <div class="card-body">
                                <div class="row">
                    ...
                    @csrf
                        <div class="mt-3 mb-2">
                            <h5><i class="fa-solid fa-square-info"></i> About Us </h5>
                        </div>
                        <div class="card border-0">
                            <div class="card-body">
                                <div class="row">
