                                ...
                                <div class="row justify-content-between align-items-center mb-2">
                                    ...
                                    <?php if(!session()->get('discount_data')): ?>
                                        <div class="col-auto"><a href="javascript:void(0)" class="text-uppercase"
                                                ...
                                                data-bs-target="#promocodemodal"><?php echo e(trans('labels.select_promocode')); ?></a></div>
                                    <?php endif; ?>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <button class="btn btn-success w-100"
                                onclick="isopenclose('<?php echo e(URL::to('/isopenclose')); ?>','<?php echo e($total_item_qty); ?>','<?php echo e($order_total); ?>')"><?php echo e(trans('labels.continue')); ?></button>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="deliveryoptionLabel">
                                                <?php echo e(trans('labels.delivery_option')); ?></h5>
                                            ...
                                            <div class="order-option">
                                                <label class="form-check-label" for="delivery">
                                                    ...
                                                    <div class="home-delivery-img">
                                                        <img src="<?php echo e(Helper::web_image_path('delivery.png')); ?>"
                                                            alt="">
                                                ...
                                                <label class="form-check-label" for="pickup">
                                                    <input class="form-check-input" type="radio" name="order_type"
                                                        value="2"
                                                        <?php echo e(session()->get('order_type') == 2 ? 'checked' : ''); ?>

                                                        id="pickup">
                                                    <div class="home-delivery-img">
                                                        <img src="<?php echo e(Helper::web_image_path('takeaway.png')); ?>"
                                                            alt="">
                                        ...
                                        <div class="modal-footer checkout-btn justify-content-center">
                                            <a href="javascript:void(0)" onclick="holduser(this)"
                                                data-url="<?php echo e(URL::to('/holduser')); ?>"
                                                data-next-url="<?php echo e(route('checkout')); ?>" type="submit"
                                                class="btn btn-primary bg-success border-0"><?php echo e(trans('labels.continue')); ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-content border-0">
                <div class="modal-body py-0 px-4 rounded">
                    <div class="modal-header border-0 px-0 pb-0">
                        <h5 class="modal-title" id="exampleModalLabel"><?php echo e(trans('labels.apply_promo')); ?></h5>
                            ...
                            <div class="card-body p-0 ps-3">
                                <div class="coupon bg-white rounded d-flex justify-content-between">
                                    <div class="left-side py-3 d-flex w-100 justify-content-start">
                                        <div>
                                            <h5><?php echo e($promocode->offer_name); ?></h5>
                                            <p class="dark_color mb-0 fw-600 fs-7 dark_color">
                                                <?php echo e(trans('labels.promocode')); ?> :
                                                <span
                                                    class="fw-normal text-decoration-underline text-uppercase text-primary"><?php echo e($promocode->offer_code); ?></span>
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="info m-3 d-flex align-items-center">
                                            <div class="w-100 d-flex flex-column align-items-center">
                                                ...
                                                <button class="btn btn-sm btn-outline-primary btn-block"
                                                    ...
                                                    data-bs-dismiss="modal"><?php echo e(trans('labels.copy')); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('web.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Skripsi\NgeMeal\resources\views/web/cart/cart.blade.php ENDPATH**/ ?>