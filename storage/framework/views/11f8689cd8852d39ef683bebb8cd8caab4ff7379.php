...
<head>
    ...
    <title> <?php echo e(@Helper::appdata()->title); ?> | <?php echo e(trans('labels.otp_verification')); ?> </title>
    <link rel="icon" href="<?php echo e(Helper::image_path(@Helper::appdata()->favicon)); ?>"><!-- Favicon -->
    <link rel="stylesheet" href="<?php echo e(url('/storage/app/public/web-assets/css/bootstrap.min.css')); ?>"><!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?php echo e(url('/storage/app/public/web-assets/css/font_awesome/all.css')); ?>"><!-- Font Awesome CSS -->
                        ...
                        <div class="auth_form">
                            <form action="<?php echo e(URL::to('verify-otp')); ?>" method="POST">
                                ...
                                <div class="m-3">
                                    ...
                                    <p class="text-white text-center w-410"><?php echo e(trans('labels.otp_note')); ?> </p>
                                    <p class="text-white text-center"><strong><?php echo e(session()->get('verification_email')); ?></strong></p>
                                </div>
                                <div class="m-3">
...
unset($__errorArgs, $__bag); ?>
                                    <?php if(session()->has('otp_error')): ?>
                                        <span class="text-light"><?php echo e(session()->get('otp_error')); ?></span>
                                    <?php endif; ?>
                                </div>
                            ...
                            <div class="m-3 d-flex align-content-center align-items-center justify-content-center d-none" id="resend">
                                <p class="text-white mb-0"><?php echo e(trans('labels.dont_receive_otp')); ?></p> 
    ...
    <script src="<?php echo e(url('/storage/app/public/web-assets/js/bootstrap/bootstrap.bundle.min.js')); ?>"></script><!-- Bootstrap JS -->
    <!-- COMMON-JS -->
...
<?php /**PATH /Users/user/Downloads/NgeMeal-master/resources/views/web/auth/verification.blade.php ENDPATH**/ ?>