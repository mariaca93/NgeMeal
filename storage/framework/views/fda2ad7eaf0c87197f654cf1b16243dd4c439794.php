<?php $__env->startSection('page_title'); ?>
    | <?php echo e(trans('labels.update_address')); ?>
    ...
    <div class="breadcrumb-sec">
        <div class="container">
            <div class="breadcrumb-sec-content">
                <h1><?php echo e(trans('labels.update_address')); ?></h1>
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="user-content-wrapper">
                        <div class="mb-3">
                            <p class="title mb-0"><?php echo e(trans('labels.update_address')); ?></p>
                        ...
                        <form action="<?php echo e(URL::to('/address/update-' . $addressdata->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" placeholder="<?php echo e(trans('labels.latitude')); ?>" class="form-control"
                                name="lat" value="<?php echo e($addressdata->lat); ?>" id="lat" readonly>
                            <?php $__errorArgs = ['lat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                <small class="text-light"><?php echo e($message); ?></small> <br>
                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                            <input type="hidden" placeholder="<?php echo e(trans('labels.longitude')); ?>" class="form-control"
                                name="lang" value="<?php echo e($addressdata->lang); ?>" id="lang" readonly>
...
unset($__errorArgs, $__bag); ?>
                            <div class="form-group mb-3">
                                <label class="form-label mb-0"><?php echo e(trans('labels.house_no')); ?></label>
                                <input type="text" class="form-control" name="house_no"
                                    placeholder="<?php echo e(trans('messages.enter_house_no')); ?>"
                                    value="<?php echo e($addressdata->house_no); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group mb-3">
                                <label class="form-label mb-0"><?php echo e(trans('labels.area')); ?></label>
                                <input type="text" class="form-control" name="area"
                                    placeholder="<?php echo e(trans('messages.enter_area')); ?>" value="<?php echo e($addressdata->area); ?>">
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label mb-0"><?php echo e(trans('labels.complete_address')); ?></label>
                                <textarea rows="3" class="form-control" name="address" placeholder="<?php echo e(trans('labels.complete_address')); ?>"><?php echo e($addressdata->address); ?></textarea>
                                ...
                                <div class="row">
                                    <div class="col-auto new-address">
                                        <label class="form-check-label" for="home">
                                            <input class="form-check-input d-none" type="radio" name="address_type"
                                                value="1" <?php echo e($addressdata->address_type == 1 ? 'checked' : ''); ?>
                                    ...
                                    <div class="col-auto new-address">
                                        <label class="form-check-label" for="office">
                                            <input class="form-check-input d-none" type="radio" name="address_type"
                                                value="2" <?php echo e($addressdata->address_type == 2 ? 'checked' : ''); ?>
                                    ...
                                    <div class="col-auto new-address">
                                        <label class="form-check-label" for="other">
                                            <input class="form-check-input d-none" type="radio" name="address_type"
                                                value="3" <?php echo e($addressdata->address_type == 3 ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <button class="btn btn-success"
                                <?php if(env('Environment') == 'sendbox'): ?> type="button" onclick="myFunction()" <?php else: ?> type="submit" <?php endif; ?>><?php echo e(trans('labels.save_address_details')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('web.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Downloads/NgeMeal-master/resources/views/web/address/update.blade.php ENDPATH**/ ?>