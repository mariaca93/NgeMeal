                    ...
                    <div class="sub-cat-tab food-type d-flex justify-content-center">
                        <nav class="nav nav-pills m-auto justify-content-center veg align-items-baseline">
                            <a class="nav-link px-3 mx-2 <?php if(isset($_GET['filter']) && $_GET['filter'] == 'veg'): ?> active-cat <?php else: ?> border <?php endif; ?>"
                                ...
                                <img src="<?php echo e(Helper::image_path('veg.svg')); ?>" class="pe-1" width="50"
                            ...
                            <a class="nav-link px-3 mx-2 <?php if(isset($_GET['filter']) && $_GET['filter'] == 'nonveg'): ?> active-cat <?php else: ?> border <?php endif; ?>"
                                ...
                                <img src="<?php echo e(Helper::image_path('nonveg.svg')); ?>" class="pe-1" width="50"
    ...
    <div class="container my-5">
        <div class="row mb-5">
            <div class="menu my-0">
                ...
                ?>
                <?php if($tipe == 'alacarte' || $tipe == 'subscription'): ?>
                    <div class="row">
                        <?php if($tipe == 'alacarte'): ?>
                        ...
                        <?php elseif($tipe == 'subscription'): ?>
                            <?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo $__env->make('web.itemview', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    </div>
                    <?php if($tipe == 'alacarte'): ?>
                        <div class="mt-5 d-flex justify-content-center">
                            <h1><?php echo e($getsearchitems->appends(request()->query())->links()); ?></h1>
...
<?php echo $__env->make('web.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Christanto\Desktop\Materi\Project Skripsi\NgeMeal\resources\views/web/viewall.blade.php ENDPATH**/ ?>