                                ...
                                <div class="row">
                                    <div class="col-auto new-address">
                                        <label class="form-check-label" for="home">
                                            <input class="form-check-input d-none" type="radio" name="address_type"
                                                value="1" <?php echo e(old('address_type') == 1 ? 'checked' : 'checked'); ?>
                                    ...
                                    <div class="col-auto new-address">
                                        <label class="form-check-label" for="office">
                                            <input class="form-check-input d-none" type="radio" name="address_type"
                                                value="2" <?php echo e(old('address_type') == 2 ? 'checked' : ''); ?>
                                    ...
                                    <div class="col-auto new-address">
                                        <label class="form-check-label" for="other">
                                            <input class="form-check-input d-none" type="radio" name="address_type"
                                                value="3" <?php echo e(old('address_type') == 3 ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <button type="submit"
                                class="btn btn-success"><?php echo e(trans('labels.save_address_details')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('web.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Christanto\Desktop\Materi\Project Skripsi\NgeMeal\resources\views/web/address/add.blade.php ENDPATH**/ ?>