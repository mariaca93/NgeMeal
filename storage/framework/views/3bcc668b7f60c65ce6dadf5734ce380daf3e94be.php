...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('web-assets/js/multiple-select/chosen.min.css')); ?>">
    <script src="<?php echo e(asset('web-assets/js/multiple-select/chosen.jquery.min.js')); ?>"></script>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('web-assets/css/bootstrap.min.css')); ?>">
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('web-assets/css/owl_carousel/owl.carousel.min.css')); ?>">
    <!-- owl-carousel css -->
    <link rel="stylesheet"
        href="<?php echo e(asset('web-assets/css/owl_carousel/owl.theme.default.min.css')); ?>">
    <!-- owl-carousel css -->
    <link rel="stylesheet" href="<?php echo e(asset('web-assets/css/font_awesome/all.css')); ?>">
    <!-- Font Awesome CSS -->
    <!-- COMMON-CSS -->
...
<body>
    ...
    <script src="<?php echo e(asset('web-assets/js/owl_carousel/owl.carousel.js')); ?>"></script><!-- owl carousel js -->
    <script src="<?php echo e(asset('web-assets/js/bootstrap/bootstrap.bundle.min.js')); ?>"></script><!-- Bootstrap CSS -->
    <!-- COMMON-FOR-TOASTER-&-SWEETALERT -->
    <script src="<?php echo e(asset('admin-assets/assets/js/toastr/toastr.min.js')); ?>"></script><!-- Toastr JS -->
    <script src="<?php echo e(asset('admin-assets/assets/js/sweetalert/sweetalert2.min.js')); ?>"></script><!-- Sweetalert JS -->
    <script>
        // COMMON-SCRIPTS
...
<?php /**PATH C:\Users\Christanto\Desktop\Materi\Project Skripsi\NgeMeal\resources\views/web/layout/default.blade.php ENDPATH**/ ?>