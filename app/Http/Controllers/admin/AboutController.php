    ...
    public function settings_update(Request $request)
    {
        ...
        if ($request->web_update) {
            if($request->hasFile('mobile_app_bg_image')){
                ...
                $request->mobile_app_bg_image->move('storage/app/public/admin-assets/images/about', $mobile_app_bg_image);
                $about = About::first();
                if(empty($about)){
                    $about = new About();
                }else{
                    if($about->mobile_app_bg_image != "" && file_exists('storage/app/public/admin-assets/images/about/'.$about->mobile_app_bg_image)){
                        unlink('storage/app/public/admin-assets/images/about/'.$about->mobile_app_bg_image);
                    }
                }
            ...
            if($request->hasFile('booknow_bg_image')){
                ...
                $request->booknow_bg_image->move('storage/app/public/admin-assets/images/about', $booknow_bg_image);
                $about = About::first();
                if(empty($about)){
                    $about = new About();
                }else{
                    if($about->booknow_bg_image != "" && file_exists('storage/app/public/admin-assets/images/about/'.$about->booknow_bg_image)){
                        unlink('storage/app/public/admin-assets/images/about/'.$about->booknow_bg_image);
                    }
                }
            ...
            if($request->hasFile('reviews_bg_image')){
                ...
                $request->reviews_bg_image->move('storage/app/public/admin-assets/images/about', $reviews_bg_image);
                $about = About::first();
                if(empty($about)){
                    $about = new About();
                }else{
                    if($about->reviews_bg_image != "" && file_exists('storage/app/public/admin-assets/images/about/'.$about->reviews_bg_image)){
                        unlink('storage/app/public/admin-assets/images/about/'.$about->reviews_bg_image);
                    }
                }
            ...
            if($request->hasFile('footer_bg_image')){
                ...
                $request->footer_bg_image->move('storage/app/public/admin-assets/images/about', $footer_bg_image);
                $about = About::first();
                if(empty($about)){
                    $about = new About();
                }else{
                    if($about->footer_bg_image != "" && file_exists('storage/app/public/admin-assets/images/about/'.$about->footer_bg_image)){
                        unlink('storage/app/public/admin-assets/images/about/'.$about->footer_bg_image);
                    }
                }
            ...
            if($request->hasFile('auth_bg_image')){
                ...
                $request->auth_bg_image->move('storage/app/public/admin-assets/images/about', $auth_bg_image);
                $about = About::first();
                if(empty($about)){
                    $about = new About();
                }else{
                    if($about->auth_bg_image != "" && file_exists('storage/app/public/admin-assets/images/about/'.$about->auth_bg_image)){
                        unlink('storage/app/public/admin-assets/images/about/'.$about->auth_bg_image);
                    }
                }
            ...
            if($request->hasFile('breadcrumb_bg_image')){
                ...
                $request->breadcrumb_bg_image->move('storage/app/public/admin-assets/images/about', $breadcrumb_bg_image);
                $about = About::first();
                if(empty($about)){
                    $about = new About();
                }else{
                    if($about->breadcrumb_bg_image != "" && file_exists('storage/app/public/admin-assets/images/about/'.$about->breadcrumb_bg_image)){
                        unlink('storage/app/public/admin-assets/images/about/'.$about->breadcrumb_bg_image);
                    }
                }
