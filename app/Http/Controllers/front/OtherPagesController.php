...
class OtherPagesController extends Controller
{
    ...
    {
        $getteams = Team::select("id","title","subtitle","fb","youtube","insta","description",\DB::raw("CONCAT('".url('/storage/app/public/admin-assets/images/about')."/', image) AS image_url"))->orderBydesc('id')->get();
    ...
    //     return view('web.faq', compact('gettutorials'));
    // }
    // blogs
